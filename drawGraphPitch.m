...
for i=1:900
    pose_est(i,:) = [(pose_est(i,1) -10) (pose_est(i,2) -10) (pose_est(i,3) -10)];
end
...
plot(frame_nos,pose_act(:,3),'color','r','DisplayName','Acutal pitch','LineWidth',1.5);
hold on;
plot(frame_nos,pose_est(:,3),'color','b','DisplayName','Estimated pitch','LineWidth',1.5);
hold on;
legend('Location','northwest');
title('Deviation of the pitch angle')
xlabel('Frame number');
ylabel('Actual and estimated pitch angles');
