...
plot(frame_nos,pose_act(:,2),'color','r','DisplayName','Acutal yaw','LineWidth',1.5);
hold on;
plot(frame_nos,pose_est(:,2),'color','b','DisplayName','Estimated yaw','LineWidth',1.5);
hold on;
legend('Location','northwest');
title('Deviation of the yaw angle')
xlabel('Frame number');
ylabel('Actual and estimated yaw angles');
